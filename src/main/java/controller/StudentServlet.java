...
public class StudentServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        studentDAO.add(new Student(1, "Материй", "Силоуков", "Ахмедов", 18 ,"matsil@gmail.com", "42.03.01", null, "+7(999)941-52-52" ));
        studentDAO.add(new Student(2, "Мустафа", "Ахмедов", "Сило", 18 ,"mustafa@mail.ru", "42.03.01", null, "+7(999)952-23-24" ));
    }
